...
class Statistic
{
    ...
    {
        if (!config('plugin.gitfei1231.statistic.app.enable')) {
            return;
        }
    ...
    public static function report()
    {
        try {
            ...
            Bootstrap::instance()->request(
                config('plugin.gitfei1231.statistic.app.address'),
                [
                    'method' => 'POST',
                    'version' => '1.1',
                    'headers' => [
                        'Connection'    => 'keep-alive',
                        'authorization' => config('plugin.gitfei1231.statistic.app.authorization', md5(date('Y')))
                    ],
                    'data' => [
